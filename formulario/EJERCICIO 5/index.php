...
<form action="" method="get">
    ...
    <!--Los bloques de echo son los unicos que no se cambian en la vista, se mantienen siempre-->
        <input type="checkbox" name="reciclaje" id="">
        <label for="reciclaje">reciclaje</label><br>
        <input type="checkbox" name="contaminacion" id="">
        <label for="contaminacion">contaminacion</label><br>
        <input type="checkbox" name="zonas industriales" id="">
        <label for="zonas industriales">zonas industriales</label><br>
        <input type="checkbox" name="vehiculos electricos" id="">
    ...
    <select name="paises" id="" required>
        <?php
            foreach ($array as $key=> $value) {
               echo '<option name="'.$value['pais'].'">'.$value['pais'].'</option>';
            }
        ?>
    </select>
